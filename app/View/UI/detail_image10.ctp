 ...
 <div id='content_layout'>
	...
	<div id='detail_map_field'>
		<div id="map_body3" class='detail_image_block'>
			<div id='desc_image'>
			<?php
				echo $this->Html->image('NW37/NW37_1.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
			...
			<div id='desc_image'>
			<?php
				echo $this->Html->image('NW37/NW37_2.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
			...
			<div id='desc_image'>
			<?php
				echo $this->Html->image('NW37/NW37_3.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
			...
			<div id='desc_image'>
			<?php
				echo $this->Html->image('NW37/NW37_4.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
