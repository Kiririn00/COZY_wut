 ...
 <div id='content_layout'>
	...
	<div id='detail_map_field'>
		<div id="map_body3" class='detail_image_block'>
			...
			<div id='desc_image'>
			<?php
				echo $this->Html->image('home/home10.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
			...
			<div id='desc_image'>
			<?php
				echo $this->Html->image('home/home13.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
            ...
            <div id='desc_image'>
			<?php
				echo $this->Html->image('home/home14.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
            ...
            <div id='desc_image'>
			<?php
				echo $this->Html->image('home/home12.jpg',array(
					'width' => 300,
					'height' => 180
				));
			 ?>
